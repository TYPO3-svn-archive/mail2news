<?php
	...
	*   72:     function getmail()
	*  179:     function getparameterline(&$text,$label)
	*  197:     function matchemail($match,$email)
	*  210:     function clearpagecache($pid_list)
	*  232:     function storebodyparts($bodyparts)
	*  278:     function saveattachment($filename, $fileext, $savepath, $attachment, $maxsize, &$filelist, &$counter)
	*
	* TOTAL FUNCTIONS: 7
